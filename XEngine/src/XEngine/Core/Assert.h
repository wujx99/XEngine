...
#include "XEngine/Core/Log.h"
	...
	#define XE_INTERNAL_ASSERT_NO_MSG(type, check) XE_INTERNAL_ASSERT_IMPL(type, check, "Assertion '{0}' failed at {1}:{2}", XE_STRINGIFY_MACRO(check), ::XEg::Assert::CurrentFileName(__FILE__), __LINE__)
